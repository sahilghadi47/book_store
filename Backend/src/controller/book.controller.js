...
const getBookById = functionHandler(async (req, res) => {
    ...
    const response = new success("Book featched successfully", book.toJSON());
...
const deleteBook = functionHandler(async (req, res) => {
    ...
    const response = new success("Book deleted successfully", book.toJSON());
...
const updateBook = functionHandler(async (req, res) => {
    ...
    const response = new success("Book updated successfully", book.toJSON());
